  ...
  return (
    <div className="h-full flex flex-col bg-white">
      <div className="px-4 py-3 border-b border-gray-200 flex-shrink-0">
        <h2 className="text-lg font-semibold text-gray-900">生成的汇编代码</h2>
      </div>
          ...
          <div className="space-y-0">
            {assemblyLines.map((line, idx) => {
              ...
              return (
                ...
                >
                  <span className={isActive ? 'font-semibold text-yellow-800' : isLabel ? 'font-semibold text-gray-900' : 'text-gray-800'}>
                    {line.code}
                  </span>
                </div>
              );
