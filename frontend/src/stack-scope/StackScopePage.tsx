...
const StackScopePage: React.FC = () => {
  ...
  const handleNextStep = useCallback(() => {
    ...
    if (currentStepIndex < flattenedStatements.length) {
      ...
      // 处理语句的作用域变化：只要遇到 StartCheckPoint 就开辟作用域，遇到 EndCheckPoint 就销毁作用域
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col overflow-hidden">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4 pl-20 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <h1 className="text-2xl font-bold text-gray-900">栈布局可视化</h1>
      ...
      <main className="flex flex-1 min-h-0 overflow-hidden">
        {/* 左侧代码编辑器 - 30% (3/10) */}
        <div className="w-[30%] p-6 border-r border-gray-200 flex-shrink-0 overflow-hidden flex flex-col">
          {/* 编辑器标题头 */}
        ...
        {/* 中间 CFG 展示区域 - 50% (5/10) */}
        <div className="w-[50%] p-6 border-r border-gray-200 flex-shrink-0 overflow-hidden">
